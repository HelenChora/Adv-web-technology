...
const UpdateProfile = () => {
    ...
    return (
        <>
            ...
            <SessionCheck />
            <div className="flex flex-col justify-center items-center text-center bg-gradient-to-b from-teal-200 to-cyan-500 h-screen">
                <div className="p-5 bg-white shadow-md shadow-black w-96 flex flex-col gap-3 rounded-lg">
                    ...
                    <div className="my-2">
                        {user.filename && (
                            <img src={`http://localhost:3000/suppliers/getImage/${user.filename}` } alt="User Image" />
                        )}
                    </div>
                    <div className="my-2">
